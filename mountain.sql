...
INSERT INTO mountain VALUES(12,'  Himalchuli','India ','	Gasherbrum I ',2457,true,325,true,3,3);
...
INSERT INTO mountain VALUES(20,' Molamenqing','USA  ','Langtang Himalaya  ',8776,false,235,false,1,3);


SELECT LTRIM(name) as Names from mountain;
SELECT LTRIM(country) as country_names from mountain;
SELECT LTRIM(place) as palces from mountain;
SELECT LTRIM(person_from) as location from mountain;
SELECT LTRIM(famous) as Names from mountain;

SELECT RTRIM(name) as Names from mountain;
SELECT RTRIM(country) as country_names from mountain;
SELECT RTRIM(place) as palces from mountain;
SELECT RTRIM(person_from) as location from mountain;
SELECT RTRIM(famous) as Names from mountain;

SELECT * FROM mountain order by name;
SELECT * FROM mountain order by id desc;
SELECT * FROM mountain order by height desc;
SELECT * FROM mountain order by country desc;
SELECT * FROM mountain order by km;